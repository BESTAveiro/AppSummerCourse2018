...
public class People extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int groupPositionorgs =groupPosition;
        ...
        switch (login) {
            ...
            case 1:
                if (groupPositionorgs == 1) {
                    ...
                    TextView name = (TextView) findViewById(R.id.texto1);
                    name.setText("Name");
                    TextView pais = (TextView) findViewById(R.id.texto2);
                    pais.setText("Role");
                    TextView sex = (TextView) findViewById(R.id.texto3);
                    sex.setText("Team");
                    TextView phonenumber = (TextView) findViewById(R.id.texto4);
